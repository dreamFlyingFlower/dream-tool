...
import com.dream.ConstI18n;
import com.dream.common.Internation;
...
public enum TipEnum implements StatusMsg {
	...
	TIP_INTERNAL_FORBIDDEN(403, ConstI18n.MSG_INTERNAL_FORBIDDEN),
	TIP_INTERNAL_SERVER_ERROR(500, ConstI18n.MSG_INTERNAL_SERVER_ERROR),
