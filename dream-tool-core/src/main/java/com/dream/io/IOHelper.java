...
import com.dream.io.output.ByteArrayOutputStream;
import com.dream.io.output.NullOutputStream;
import com.dream.io.output.StringBuilderWriter;
...
public final class IOHelper {
	...
	/**
	 * 复制一个超过2GB的输入流中的字节到一个输出流中,需自行关闭流
	 *
	 * @param input 输入流,读数据
	 * @param output 输出流,写数据
	...
	public static void copy(final InputStream input, final Writer output, final Charset inputCharset)
			throws IOException {
		Objects.requireNonNull(input, "inputstream can't by null");
		final InputStreamReader in = new InputStreamReader(input, CharsetHelper.defaultCharset(inputCharset));
		copy(in, output);
	}
	...
	public static void copy(final InputStream input, final Writer output, final String inputCharsetName)
			throws IOException {
		copy(input, output, CharsetHelper.defaultCharset(inputCharsetName));
	}
	...
	public static void copy(final Reader input, final OutputStream output, final Charset outputCharset)
			throws IOException {
		Objects.requireNonNull(output, "outputstream can't by null");
		OutputStreamWriter out = new OutputStreamWriter(output, CharsetHelper.defaultCharset(outputCharset));
		copy(input, out);
	}
	...
	public static void copy(final Reader input, final OutputStream output, final String outputCharsetName)
			throws IOException {
		copy(input, output, CharsetHelper.defaultCharset(outputCharsetName));
	}
	...
	public static String copyToString(final InputStream input) throws IOException {
		return copyToString(input, ConstLang.DEFAULT_CHARSET);
	}
	 ...
	 * @return 字符串
	 */
	public static String copyToString(final InputStream input, final String charsetName) throws IOException {
		return copyToString(input, CharsetHelper.defaultCharset(charsetName));
	}
	 ...
	 * @return 输入流中的字符串
	 */
	public static String copyToString(final Reader input) throws IOException {
		try (final StringBuilderWriter sw = new StringBuilderWriter()) {
			copy(input, sw);
			return sw.toString();
		}
	...
	public static String copyToString(final URI uri) throws IOException {
		return copyToString(uri, ConstLang.DEFAULT_CHARSET);
	}
	...
	public static String copyToString(final URI uri, final Charset charset) throws IOException {
		...
		return copyToString(uri.toURL(), CharsetHelper.defaultCharset(charset));
	}
	 ...
	 * @return URI资源中的字符串
	 */
	public static String copyToString(final URI uri, final String charsetName) throws IOException {
		return copyToString(uri, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static String copyToString(final URL url) throws IOException {
		return copyToString(url, ConstLang.DEFAULT_CHARSET);
	}
	 ...
	 * @return 字符串
	 */
	public static String copyToString(final URL url, final String charsetName) throws IOException {
		return copyToString(url, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static ReaderLineIterator lineIterator(final InputStream input, final Charset charset) throws IOException {
		return new ReaderLineIterator(new InputStreamReader(input, CharsetHelper.defaultCharset(charset)));
	}
	...
	public static ReaderLineIterator lineIterator(final InputStream input, final String charsetName)
			throws IOException {
		return lineIterator(input, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static List<String> readLines(final InputStream input, final String charsetName) throws IOException {
		return readLines(input, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static byte[] toByteArray(final InputStream input, int size) throws IOException {
		...
		return ArrayHelper.merge(buffers.toArray(new byte[buffers.size()][]));
	}
	...
	public static byte[] toByteArray(final Reader input, final String charsetName) throws IOException {
		return toByteArray(input, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static char[] toCharArray(final InputStream is, final String charsetName) throws IOException {
		return toCharArray(is, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static InputStream toInputStream(final CharSequence input, final Charset charset) {
		AssertHelper.notEmpty(input);
		return new ByteArrayInputStream(input.toString().getBytes(CharsetHelper.defaultCharset(charset)));
	}
	...
	public static InputStream toInputStream(final CharSequence input, final String charsetName) {
		return toInputStream(input, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static void write(final byte[] data, final Writer output, final Charset charset) throws IOException {
		if (data != null) {
			output.write(new String(data, CharsetHelper.defaultCharset(charset)));
		}
	}
	...
	public static void write(final byte[] data, final Writer output, final String charsetName) throws IOException {
		write(data, output, CharsetHelper.defaultCharset(charsetName));
	}
	...
	public static void write(final char[] data, final OutputStream output, final Charset charset) throws IOException {
		if (data != null) {
			output.write(new String(data).getBytes(CharsetHelper.defaultCharset(charset)));
		}
	}
	...
	public static void writeLines(final Collection<?> lines, String lineEnding, final OutputStream output,
		...
		final Charset cs = CharsetHelper.defaultCharset(charset);
	...
	public static void writeLines(final Collection<?> lines, final String lineEnding, final OutputStream output,
		...
		writeLines(lines, lineEnding, output, CharsetHelper.defaultCharset(charsetName));
	}
