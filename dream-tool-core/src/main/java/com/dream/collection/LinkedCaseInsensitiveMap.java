...
/**
 * {@link LinkedHashMap}以不区分大小写的方式存储字符串Key
 * 
 * @author 飞花梦影
 * @date 2021-03-22 13:41:11
...
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with an initial
	 * capacity that can accommodate the specified number of elements without any immediate
	 * resize/rehash operations to be expected, storing case-insensitive keys according to the
	 * default Locale (in lower case).
	 * 
	 * @param expectedSize the expected number of elements (with a corresponding capacity to be
	 *        derived so that no resize/rehash operations are needed)
	 ...
	 * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with an initial
	 * capacity that can accommodate the specified number of elements without any immediate
	 * resize/rehash operations to be expected, storing case-insensitive keys according to the given
