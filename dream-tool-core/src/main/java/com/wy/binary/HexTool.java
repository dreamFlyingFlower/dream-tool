...
public class HexTool {
	...
	public byte[] decode(final byte[] data, Charset charset) {
		return decode(new String(data, CharsetTool.defaultCharset(charset)).toCharArray());
	}
	...
	public byte[] decode(final byte[] data, String encoding) {
		return decode(new String(data, CharsetTool.defaultCharset(encoding)).toCharArray());
	}
