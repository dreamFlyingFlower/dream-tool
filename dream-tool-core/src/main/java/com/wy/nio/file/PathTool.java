...
public class PathTool {
	...
	public static void copy(Path source, Path target) throws IOException {
		AssertTool.notNull(source, "Source Path must not be null");
		AssertTool.notNull(target, "Target Path must not be null");
	...
	public static Path copyFile(Path source, Path target, CopyOption... options) throws IOException {
		AssertTool.notNull(source, "The source file can't be null !");
		AssertTool.notNull(target, "The destination file or directiory can't be null !");
	...
	public static String getFileExtension(Path path) {
		AssertTool.notNull(path, "The path of the file can't be null");
		return FileTool.getFileExtension(path.toFile());
	}
	...
	public static String getNameNoExtension(Path path) {
		AssertTool.notNull(path, "The path of the file can't be null");
		return FileTool.getNameNoExtension(path.toFile());
	}
	...
	public static BufferedReader newBufferedReader(Path path) throws IOException {
		return Files.newBufferedReader(path, CharsetTool.defaultCharset());
	}
	...
	public static BufferedReader newBufferedReader(Path path, Charset charset) throws IOException {
		return Files.newBufferedReader(path, CharsetTool.defaultCharset(charset));
	}
	...
	public static InputStream newInputStream(Path path, OpenOption... options) throws IOException {
		AssertTool.notNull(path, "the path can't be null");
	...
	public static List<String> readLines(Path path) throws IOException {
		return null == path ? Collections.emptyList() : Files.readAllLines(path, CharsetTool.defaultCharset());
	}
	...
	public static List<String> readLines(Path path, Charset charset) throws IOException {
		return null == path ? Collections.emptyList() : Files.readAllLines(path, CharsetTool.defaultCharset(charset));
	}
	...
	public static void write(Path path, String str, OpenOption... options) throws IOException {
		write(path, Arrays.asList(str), CharsetTool.defaultCharset(), options);
	}
	...
	public static void write(Path path, List<String> lines, String charsetName, OpenOption... options)
			throws IOException {
		write(path, lines, CharsetTool.defaultCharset(charsetName), options);
	}
}