...
public class RegularTool {
	 ...
	 *
	 * <p>
	 * Unlike in the {@link #removePattern(String, String)} method, the {@link Pattern#DOTALL}
	...
	public static String removePattern(final String text, final String regex) {
		return replacePattern(text, regex, ConstantLang.STR_EMPTY);
	}
	 ...
	 * {@link Pattern#DOTALL} option is NOT automatically added. To use the DOTALL option prepend
	 * {@code "(?s)"} to the regex. DOTALL is also known as single-line mode in Perl.
	 * </p>
	 *
	 * <pre>
	 * StringUtils.replaceAll(null, *, *)       = null
	 ...
	 * the given replacement using the {@link Pattern#DOTALL} option. DOTALL is also known as
