...
public final class DateTool {
	...
	public static Date parse(String date) {
		if (StrTool.checkValidity(date, RegexEnum.REGEX_DATE)) {
			return parse(date, DateEnum.DATE);
		}
		if (StrTool.checkValidity(date, RegexEnum.REGEX_DATE_NONE)) {
			return parse(date, DateEnum.DATE_NONE);
		}
		if (StrTool.checkValidity(date, RegexEnum.REGEX_DATE_SLASH)) {
			return parse(date, DateEnum.DATE_SLASH);
		}
		if (StrTool.checkValidity(date, RegexEnum.REGEX_DATETIME)) {
			return parse(date, DateEnum.DATETIME);
		}
		if (StrTool.checkValidity(date, RegexEnum.REGEX_DATETIME_NONE)) {
			return parse(date, DateEnum.DATETIME_NONE);
		}
		if (StrTool.checkValidity(date, RegexEnum.REGEX_DATETIME_SLASH)) {
	...
	public static Date parse(String date, String pattern) {
		try {
			if (StrTool.isAnyBlank(pattern, date)) {
				return null;
			}
	...
	public static long span2Date(String date1Str, String date2Str) {
		Date date1 = DateTool.parse(date1Str);
		Date date2 = DateTool.parse(date2Str);
