...
public class SocketTool {
	...
	private enum SocketType {
		...
		int findAvailablePort(int minPort, int maxPort) {
			AssertTool.isTrue(minPort > 0, "'minPort' must be greater than 0");
			AssertTool.isTrue(maxPort >= minPort, "'maxPort' must be greater than or equal to 'minPort'");
			AssertTool.isTrue(maxPort <= PORT_RANGE_MAX, "'maxPort' must be less than or equal to " + PORT_RANGE_MAX);
		...
		SortedSet<Integer> findAvailablePorts(int numRequested, int minPort, int maxPort) {
			AssertTool.isTrue(minPort > 0, "'minPort' must be greater than 0");
			AssertTool.isTrue(maxPort > minPort, "'maxPort' must be greater than 'minPort'");
			AssertTool.isTrue(maxPort <= PORT_RANGE_MAX, "'maxPort' must be less than or equal to " + PORT_RANGE_MAX);
			AssertTool.isTrue(numRequested > 0, "'numRequested' must be greater than 0");
			AssertTool.isTrue((maxPort - minPort) >= numRequested,
