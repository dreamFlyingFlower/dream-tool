...
public class ResourceTool {
	...
	public static String getRootPath() {
		return ResourceTool.class.getResource("/").getPath().replace("target/classes/", "");
	}
	...
	public static String getRootClassPath() {
		return ResourceTool.class.getResource("/").getPath();
	}
	...
	public static Properties readProperties(String path) throws IOException {
		InputStream inputStream = ResourceTool.class.getResourceAsStream(path);
		if (null == inputStream) {
			inputStream = ResourceTool.class.getClassLoader().getResourceAsStream(path);
		}
	...
	public static Properties readProperties(List<String> paths) throws IOException {
		...
		for (String path : paths) {
			inputStream = ResourceTool.class.getResourceAsStream(path);
			if (null == inputStream) {
				inputStream = ResourceTool.class.getClassLoader().getResourceAsStream(path);
			}
			if (null != inputStream) {
	...
	public static File toFile(String resourceLocation) throws FileNotFoundException {
		AssertTool.notNull(resourceLocation, "Resource location must not be null");
		if (resourceLocation.startsWith(CLASSPATH_URL_PREFIX)) {
			String path = resourceLocation.substring(CLASSPATH_URL_PREFIX.length());
			String description = "class path resource [" + path + "]";
			ClassLoader cl = ClassTool.getClassLoader();
	...
	public static File toFile(URL url, String description) throws FileNotFoundException {
		AssertTool.notNull(url, "Resource URL must not be null");
	...
	public static File toFile(URI uri, String description) throws FileNotFoundException {
		AssertTool.notNull(uri, "Resource URI must not be null");
	...
	public static URL toURL(String location) throws FileNotFoundException {
		AssertTool.notNull(location, "Resource location must not be null");
