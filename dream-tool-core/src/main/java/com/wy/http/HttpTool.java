...
import com.wy.enums.http.HttpMethod;
...
public class HttpTool {
	 ...
	 */
	public static String sendGet(String desUrl, Map<String, Object> params, boolean isEncode, String charset,
			int timeout) {
		try {
	 ...
	 */
	public static String sendPost(String desUrl, String params) {
	 ...
	 * @param isEncode:是否编码,false不编码
	 */
	public static String sendPost(String desUrl, String params, String contentType) {
	 ...
	 * @param isEncode:是否编码,false不编码
	 */
	public static String sendPost(String desUrl, String params, String contentType, String charset) {
	 ...
	 * @param params 由Map或Bean转换而成的json字符串参数
	 */
	public static String sendPost(String desUrl, String params, String contentType, String charset, int timeout) {
		try {
			...
			// 维持长连接
			conn.setRequestProperty("Connection", "keep-Alive");
			conn.setRequestProperty("charset", charset = StrTool.isBlank(charset) ? DEFAULT_CHARSET : charset);
			conn.setRequestProperty("Content-Encoding", "gzip");
			conn.setRequestProperty("Contert-length", String.valueOf(desUrl.length()));
