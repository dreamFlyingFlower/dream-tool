...
public class ObjectTool {
	...
	public static <T> T median(final Comparator<T> comparator, final T... items) {
		AssertTool.notEmpty(items, "null/empty items");
		AssertTool.noNullElements(items);
		AssertTool.notNull(comparator, "comparator");
