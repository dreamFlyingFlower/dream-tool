...
public class NumberHelper {
	...
	public static BigDecimal defaultIfNull(BigDecimal number, BigDecimal defaultValue) {
		AssertHelper.notNull(defaultValue);
	...
	public static boolean isDigits(Object obj) {
		...
		return optional.isPresent() ? StrHelper.isNumeric(optional.get().toString()) : false;
	}
	...
	public static byte min(final byte... array) {
		AssertHelper.isNull(array, "this array can not be empty");
		byte min = array[0];
