...
import dream.flying.flower.collection.ListHelper.ListBuilder;
...
public class ReflectHelper {
	...
	public static <T> Field getField(T obj, String fieldName) {
		AssertHelper.notNull(obj, "Object must not be null");
	...
	public static Field getField(Class<?> clazz, String fieldName) {
		...
		AssertHelper.notBlank(fieldName, "The name of the field must be specified");
	...
	public static <T> List<String> getFieldNames(Class<T> clazz, boolean superClass, boolean ignoreStatic,
		...
		ListBuilder<String> builder = ListHelper.builder();
		Class<?> searchType = clazz;
		while (Object.class != searchType && searchType != null) {
			for (Field field : fields) {
				fixAccessible(field);
	...
	public static <T> List<Field> getFields(Class<T> clazz, boolean superClass, boolean ignoreStatic,
			boolean ignoreFinal) {
		AssertHelper.notNull(clazz, "Class must not be null");
		ListBuilder<Field> builder = ListHelper.builder();
		Class<?> searchType = clazz;
	...
	public static Method getMethod(Class<?> clazz, String name, Object[] args)
			throws NoSuchMethodException, SecurityException {
		return getMethod(clazz, name, true, true, ClassHelper.toClass(args));
	}
	...
	public static Method getMethod(Class<?> clazz, String name, boolean forceAccess, boolean superClass,
		...
		AssertHelper.notNull(clazz, "Class must not be null");
		AssertHelper.notNull(name, "Method name must not be null");
		Class<?> searchType = clazz;
		// 从本类或父类中查找
	...
	public static int getMethodCount(Class<?> clazz, String methodName, boolean superClass, boolean superInterface) {
		AssertHelper.notNull(clazz, "Class must not be null");
		AssertHelper.notNull(methodName, "Method name must not be null");
		int count = 0;
		Method[] declaredMethods = clazz.getDeclaredMethods();
	...
	public static List<Method> getMethodsByAnnotation(final Class<?> clazz,
		...
		final List<Class<?>> classes =
				(searchSupers ? ClassHelper.getSuperclassesAndInterfaces(clazz) : new ArrayList<>());
		classes.add(0, clazz);
	...
	public static <T> T newProxy(Class<T> interfaceType, InvocationHandler handler) {
		...
		AssertHelper.notNull(interfaceType.isInterface(), "%s is not an interface", interfaceType);
		Object object =
	...
	public static <T> T invokeConstructor(final Class<T> cls, Object... args)
		...
		final Class<?>[] parameterTypes = ClassHelper.toClass(args);
	...
	public static Object readField(Object obj, final String fieldName, boolean forceAccess)
			throws IllegalArgumentException, IllegalAccessException {
		AssertHelper.notNull(obj, "Object can't be null");
		AssertHelper.notBlank(fieldName, "FieldName can't be blank");
	...
	public static Object readFieldStatic(Field field, boolean forceAccess)
			throws IllegalArgumentException, IllegalAccessException {
		AssertHelper.notNull(field, "The field can't be null");
		AssertHelper.isTrue(Modifier.isStatic(field.getModifiers()), "The field '%s' is not static", field.getName());
	...
	public static Object readFieldStatic(Class<?> clazz, final String fieldName, boolean forceAccess)
			throws IllegalArgumentException, IllegalAccessException {
		AssertHelper.notNull(clazz, "Class can't be null");
		AssertHelper.notBlank(fieldName, "FieldName can't be blank");
	...
	public static void writeField(final Field field, final Object target, final Object value, final boolean forceAccess)
			throws IllegalAccessException {
		AssertHelper.notNull(field, "The field must not be null");
		fixAccessible(field, forceAccess);
	...
	public static void writeField(final String fieldName, final Object target, final Object value,
		...
		AssertHelper.notNull(target, "target object must not be null");
		final Field field = getField(target.getClass(), fieldName);
		AssertHelper.notNull(field, "Cannot locate declared field %s.%s", target.getClass().getName(), fieldName);
		fixAccessible(field, forceAccess);
	...
	public static void writeFieldStatic(final Field field, final Object value, final boolean forceAccess)
			throws IllegalAccessException {
		AssertHelper.notNull(field, "The field must not be null");
		AssertHelper.isTrue(Modifier.isStatic(field.getModifiers()), "The field %s.%s is not static",
	...
	public static void writeFieldStatic(final Class<?> clazz, final String fieldName, final Object value,
		...
		AssertHelper.notNull(field, "Cannot locate field %s on %s", fieldName, clazz);
		fixAccessible(field, forceAccess);
